...
module.exports = class Sync {
    ...
    async sync(cachedAudioFilePathToMetadata = undefined) {
        ...
        this._syncPlaylists(this._targetFolderPath, metadata, this._recordError.bind(this),
            this._recordStatus.bind(this));

        // Copy audio files that don't need to be transcoded
        this._syncNonTranscodableAudioFiles(musicFolderPath, metadata.audioFilePathToMetadata,
            this._recordStatus.bind(this));
        ...
        this._prepareToSyncTranscodableAudioFiles(concurrentPromisePool, musicFolderPath,
        ...
        if (this._previousRunStatus === null ||
            ...
            Object.keys(FileSystemUtils.getAllFilePaths(this._targetFolderPath))
                .forEach(targetFilePath => {
                    ...
                    this._deleteObsoleteFile(settings, targetFilePath, metadata);
                });
        }
    }

    _deleteObsoleteFile(settings, targetFilePath, metadata) {
    ...
    _syncPlaylists(targetFolder, metadata, recordErrorCallback, recordStatusCallback) {
    ...
    _syncNonTranscodableAudioFiles(musicFolderPath, audioFilePathToMetadata, callback) {
    ...
    _prepareToSyncTranscodableAudioFiles(pool, targetFolder, audioFilePathToMetadata, callback) {
    ...
    _getTargetFilePath(targetFolder, sourceFilePath, targetFileType) {
