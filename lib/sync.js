...
module.exports = class Sync {
    ...
    async sync(cachedAudioFilePathToMetadata = undefined) {
        ...
        this.#contentToSync = this.#getContentToSync();
        ...
        // Write metadata.json *after* call to deleteObsoleteContent.
    ...
    #getContentToSync() {
        ...
        tracks.concat(playlistTracks, albumTracks).forEach(sourceFilePath => {
    ...
    #deleteObsoleteFile(targetFilePath) {
        if ((AudioFileUtils.isAudioFile(this.#settings, targetFilePath) || AudioFileUtils.isPlaylist(targetFilePath)) &&
            !this.#contentToSync.targetPaths.playlists.has(targetFilePath) &&
            !this.#contentToSync.targetPaths.tracks.has(targetFilePath)) {
        ...
        Object.entries(this.#metadata.audioFilePathToMetadata)
            ...
            .forEach(function ([sourceFilePath, metadata]) {
                ...
                if (AudioFileUtils.shouldUpdate(sourceFilePath, targetFilePath, true)) {
                    ...
                    callback(sourceFilePath, targetFilePath, true);
                }
            }, this);
    }
    ...
    #displayStatus() {
        ...
        log(`Tracks: ${Object.keys(this.#metadata.audioFilePathToMetadata).length}`);
