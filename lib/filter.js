...
module.exports = class Filter {
    ...
    static getFilterSettings(filterCheckbox, filterFieldName, filterOperation, filterText, filterCaseInsensitive, albums) {
        let fieldName = filterFieldName.options[filterFieldName.selectedIndex].value;

        if (fieldName === 'playlistAlbumName' && albums) {
            fieldName = 'album';
        }
