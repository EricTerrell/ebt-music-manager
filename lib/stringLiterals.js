...
module.exports = class StringLiterals {
    ...
    // Audio File Type Actions
    static get CONVERT_TO_MP3() { return 'convert to mp3'; }
    ...
    static get ROW_SELECTED() { return 'rowSelected'; }
    static get ROW_DESELECTED() { return 'rowDeselected'; }
    ...
    static get PROCESSING_COMPLETE() { return 'processing-complete'; }
    static get PROGRESS_MESSAGE() { return 'progress-message'; }
    static get ADD_TO_PLAYLIST_UI() { return 'add-to-playlist-ui'; }
    static get PLAY_UI() { return 'play-ui'; }
    static get EDIT_TRACK_TITLES() { return 'edit-track-titles'; }
    static get EDIT_TRACK_TITLES_INIT() { return 'edit-track-titles-init'; }

    static get BUSY_DIALOG_CONFIGURE() { return 'busy-dialog-configure'; }
    static get UPSERT_PLAYLIST() { return 'added-playlist'; }
    static get CHECK_FOR_UPDATES() { return 'check-for-updates'; }

    static get SEARCH_AND_REPLACE() { return 'search-and-replace'; }
    ...
    // Grid columns
    static get COLUMN_SEQUENCE() { return 'sequence'; }

    static get CHANGE_TRACK_ORDER() { return 'change-track-order'; }

    // Grid sorting
    static get GRID_SORT_ASCENDING() { return 'asc'; }

    // HTML Display
    static get DISPLAY_INLINE() { return 'inline'; }
    static get DISPLAY_BLOCK() { return 'block'; }
    static get DISPLAY_NONE() { return 'none'; }
    ...
    static get TOP_OF_GRID() { return 'top'; }

    static get CANCEL_FILENAME() { return 'cancel'; }

    static get LOG_FILENAME() { return 'ebt-music-manager.txt'; }

    static get SYNC_STATUS_FILENAME() { return 'sync-status.json'; }
};
