...
module.exports = class ScanForMetadata {
    ...
    static async scan(sourceFolderPath, targetFolderPath, cachedAudioFilePathToMetadata = undefined) {
        ...
        return this.buildScanResults(playlistFilePaths, audioFilePathToMetadata, targetFolderPath);
    }

    static buildScanResults(playlistFilePaths, audioFilePathToMetadata, targetFolderPath) {
