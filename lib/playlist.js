...
module.exports = class Playlist {
    ...
    write(metadata, callback, settings) {
        ...
        if (AudioFileUtils.shouldUpdate(this.#sourceFilePath, playlistTargetFilePath)) {
            ...
            audioFilePaths.forEach(audioFilePath => {
                try {
                    ...
                    const playlistLine = `../${StringLiterals.MUSIC_TARGET_FOLDER}/${album}/${fileName}.${targetFileType}\r\n`;
    ...
    verify(metadata, errors) {
        ...
        audioFilePaths.forEach(audioFilePath => {
            ...
            audioFilePath = `${this.#targetFolder}\\${audioFilePath}`;
